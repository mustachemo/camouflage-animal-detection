...
data_dir = "/home/deep/animaldata/Labeled_MaskDataset"  # Updated path for VM mount
if not os.path.isdir(data_dir):
    ...
    # Save the model
    torch.save(model.state_dict(), "/home/deep/fine_tuned_model.pth")
    print("Model saved as 'fine_tuned_model.pth'.")

    # Save metrics to JSON
    with open("/home/deep/training_metrics.json", "w") as f:

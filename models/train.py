...
if __name__ == "__main__":
    ...
    #     "\home\mustachemo\Projects\camouflage-animal-detection/sam2",
    #     version_base="1.2",
    # # )
    # initialize_config_module(
    #     "./sam2/configs/sam2.1_training/",
    #     version_base="1.2",
    # )
    ...
    # check if args.config is a valid path
    if not Path(args.config).exists():
        print(f"Path is at {args.config}")
        print(f"Current working directory is at {Path.cwd()}")
